...
def publish_device_data(client, device_id):
    ...
    message = {
        ...
        "deviceType":"Three-Phase",
        "total_active_power": round(random.uniform(4000, 7000),2),
        "energy_consumption": round(random.uniform(40, 50),2),
        "voltage_phase_a": round(random.uniform(210, 260),2),
        "voltage_phase_b": round(random.uniform(210, 260),2),
        "voltage_phase_c": round(random.uniform(210, 260),2),
        "current_phase_a": round(random.uniform(10,60),2),
        "current_phase_b": round(random.uniform(10,60),2),
        "current_phase_c": round(random.uniform(10,60),2),
        "total_power_factor": round(random.uniform(0,1),2),
        "frequency": 50.0
    }
...
def main():
    ...
    try:
        while True:
            for device_id in range(16, 21):  # Loop through 15 devices
